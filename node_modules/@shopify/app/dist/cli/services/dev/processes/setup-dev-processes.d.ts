...
export declare function setupDevProcesses({ localApp, remoteAppUpdated, token, remoteApp, storeFqdn, commandOptions, network, usesUnifiedDeployment, partnerUrlsUpdated, }: DevConfig): Promise<{
