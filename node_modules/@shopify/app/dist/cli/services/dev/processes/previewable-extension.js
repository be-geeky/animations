...
export const launchPreviewableExtensionProcess = async ({ stderr, stdout, abortSignal }, { apiKey, storeFqdn, subscriptionProductUrl, port, cartUrl, proxyUrl, appName, appDotEnvFile, appId, grantedScopes, previewableExtensions, appDirectory, }) => {
