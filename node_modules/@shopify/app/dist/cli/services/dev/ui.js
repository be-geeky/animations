...
export async function renderDev({ processes, previewUrl, app, abortController, graphiqlUrl }) {
    if (terminalSupportsRawMode(process.stdin)) {
        return render(React.createElement(Dev, { processes: processes, abortController: abortController, previewUrl: previewUrl, app: app, graphiqlUrl: graphiqlUrl }), {
            exitOnCtrlC: false,
        });
    }
    else {
