import { PaymentMethodAttributesResult, PaymentMethodAttributesChange, PaymentMethodAttribute } from '@shopify/ui-extensions/checkout';
/**
 ...
 */
export declare function usePaymentAttributeValues(keys: string[]): (PaymentMethodAttribute['value'] | undefined)[];
/**
