...
function useShippingOptionTarget() {
  ...
  if (!api$1.target || !api$1.isTargetSelected) {
    throw new errors.ExtensionHasNoTargetError('useShippingOptionTarget', api$1.extension.target);
  }
  return {
    shippingOptionTarget: subscription.useSubscription(api$1.target),
    isTargetSelected: subscription.useSubscription(api$1.isTargetSelected)
  };
}
